from fast_mda_traceroute.links import (
    ...
    group_replies_by_ttl,
)


def test_group_replies_by_flow(make_reply):
    replies_flow_1 = [
...
def test_group_replies_by_ttl(make_reply):
    replies_ttl_1 = [
        make_reply(1, "::9", 24000, 33434, 1, "::1"),
        make_reply(1, "::9", 24001, 33434, 1, "::1"),
    ]
    ...
    assert group_replies_by_ttl([*replies_ttl_1, *replies_ttl_2, *replies_ttl_3]) == {
        1: replies_ttl_1,
        2: replies_ttl_2,
        3: replies_ttl_3,
    }
